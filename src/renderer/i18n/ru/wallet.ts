...
const wallet: WalletMessages = {
  ...
  'wallet.upgrade.pending': 'Обновляю',
  'wallet.upgrade.success': 'Успешно обновлено',
  'wallet.upgrade.error': 'Ошибка обновления',
  ...
  'wallet.upgrade.feeError': 'Комиссия для обновления {fee} не покрывается вашим балансом {balance}',
