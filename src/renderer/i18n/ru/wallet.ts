...
const wallet: WalletMessages = {
  ...
  'wallet.nav.poolshares': 'Вклады пула',
  ...
  'wallet.imports.keystore.upload': 'Выберите файл для загрузки',
  ...
  'wallet.phrase.error.invalid': 'Invalid mnemonic seed phrase',
  'wallet.phrase.error.import': 'Error while importing passphrase',
