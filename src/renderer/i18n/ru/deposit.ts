...
const deposit: DepositMessages = {
  ...
  'deposit.share.sym.title': 'Your pool share (symmetrical) -RU',
  'deposit.share.asym.title': 'Your pool share (asymmetrical) - RU',
  ...
  'deposit.add.sym': 'Добавить {asset1} + {asset2}',
  ...
  'deposit.pool.noShares.sym': "You don't have symmetrical shares in this pool - RU",
  'deposit.pool.noShares.asym': "You don't have asymmetrical shares in this pool - RU",
  'deposit.withdraw.sym': 'Withdraw {asset1} + {asset2} - RU',
  'deposit.withdraw.asym': 'Withdraw {asset} - RU',
  'deposit.withdraw.sym.title': 'Adjust withdrawal (symmetrical) - RU',
  'deposit.withdraw.asym.title': 'Adjust withdrawal (asymmetrical) - RU',
