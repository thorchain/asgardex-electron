...
const deposit: DepositMessages = {
  ...
  'deposit.interact.bond.sending': 'Отправка транзакции на вклад',
  'deposit.interact.bond.checkResults': 'Провекрка транзакции на вклад',
  'deposit.interact.unbond.sending': 'Отправка транзакции на изъятие',
  'deposit.interact.unbond.checkResults': 'Проверка транзакции на изъятие',
  'deposit.interact.leave.sending': 'Отправка транзакции на выход',
  'deposit.interact.leave.checkResults': 'Проверка транзакции на выход',
  'deposit.bond.state.success': 'Успешно вложено',
  'deposit.bond.state.error': 'Ошибка при кладе',
  'deposit.unbond.state.success': 'Успешшно выведено',
  'deposit.unbond.state.error': 'Ошибка при выводе',
  'deposit.leave.state.success': 'Успешно вышли',
