...
const common: CommonMessages = {
  ...
  'common.asset': 'Актив',
  'common.pool': 'Пул',
  'common.pool.inbound': 'Pool Inbound - RU',
  'common.pools': 'Пулы',
  'common.price': 'Цена',
  ...
  'common.fee': 'Комиссия',
  'common.fee.inbound': 'Inbound - RU',
  'common.fee.outbound': 'Outbound - RU',
  'common.fee.affiliate': 'Affiliate - RU',
