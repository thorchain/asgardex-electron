...
const deposit: DepositMessages = {
  ...
  'deposit.interact.bond.sending': 'Send bond transaction',
  'deposit.interact.bond.checkResults': 'Check bond result',
  'deposit.interact.unbond.sending': 'Send unbond transaction',
  'deposit.interact.unbond.checkResults': 'Check unbond result',
  'deposit.interact.leave.sending': 'Send leave transaction',
  'deposit.interact.leave.checkResults': 'Check leave result',
  'deposit.bond.state.success': 'Bond success',
  'deposit.bond.state.error': 'Bond error',
  'deposit.unbond.state.success': 'Unbond success',
  'deposit.unbond.state.error': 'Unbond error',
  'deposit.leave.state.success': 'Leave success',
