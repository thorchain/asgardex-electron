...
const wallet: WalletMessages = {
  ...
  'wallet.phrase.error.valueRequired': 'Value for phrase is required - DE',
  'wallet.phrase.error.invalid': 'Invalid mnemonic seed phrase - DE',
  'wallet.phrase.error.import': 'Error while importing passphrase - DE',
  ...
  'wallet.errors.asset.notExist': 'No {asset} asset - DE',
  'wallet.errors.address.empty': 'Keine Addresse angegeben',
  'wallet.errors.address.invalid': 'Addresse ist nicht valide',
  'wallet.errors.address.couldNotFind': 'Could not find {pool} pool address - DE',
  ...
  'wallet.upgrade.error.loadPoolAddress': '{pool} pool address could not be loaded - DE',
