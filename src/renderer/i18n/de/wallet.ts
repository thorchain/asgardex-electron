...
const wallet: WalletMessages = {
  ...
  'wallet.imports.error.instance': 'Could not create an instance of Client - DE',
  'wallet.imports.error.keystore.load': 'Error while loading keystore - DE',
  'wallet.imports.error.keystore.import': 'Error while importing keystore - DE',
