...
const deposit: DepositMessages = {
  ...
  'deposit.share.sym.title': 'Dein Poolanteil (symmetrisch)',
  'deposit.share.asym.title': 'Dein Poolanteil (asymmetrisch)',
  ...
  'deposit.pool.noShares.sym': 'Du hast keine symmetrischen Anteile in diesem Pool',
  'deposit.pool.noShares.asym': 'Du hast keine unsymmetrischen Anteile in diesem Pool',
