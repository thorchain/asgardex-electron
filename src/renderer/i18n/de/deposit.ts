...
const deposit: DepositMessages = {
  ...
  'deposit.interact.bond.sending': 'Send bond transaction - DE',
  'deposit.interact.bond.checkResults': 'Check bond result - DE',
  'deposit.interact.unbond.sending': 'Send unbond transaction - DE',
  'deposit.interact.unbond.checkResults': 'Check unbond result - DE',
  'deposit.interact.leave.sending': 'Send leave transaction - DE',
  'deposit.interact.leave.checkResults': 'Check leave result - DE',
  'deposit.bond.state.success': 'Bond success - DE',
  'deposit.bond.state.error': 'Bond error - DE',
  'deposit.unbond.state.success': 'Unbond success - DE',
  'deposit.unbond.state.error': 'Unbond error - DE',
  'deposit.leave.state.success': 'Leave success - DE',
