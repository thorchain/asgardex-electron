...
const deposit: StakeMessages = {
  ...
  'deposit.drag': 'Ziehen um zu Staken',
  ...
  'deposit.withdraw.title': 'Adjust withdrawal - DE',
  'deposit.withdraw.choseText': 'Wähle einen Betrag zwischen 0 und 100% zum Abheben',
  ...
  'deposit.withdraw.drag': 'Ziehen um Abzuheben'
}
