...
const wallet: WalletMessages = {
  ...
  'wallet.nav.poolshares': 'Parts de la pool',
  ...
  'wallet.connect.instruction': 'Veuillez connecter votre wallet',
  'wallet.unlock.title': 'Déverrouiller votre wallet',
  'wallet.unlock.instruction': 'Veuillez déverrouiller votre wallet',
  'wallet.unlock.phrase': 'Entrer votre phrase',
  'wallet.unlock.error': 'Impossible de déverrouiller le wallet. Veuillez vérifier votre mot de passe et réessayez',
  'wallet.imports.keystore.select': 'sélectionner le fichier clé privée',
  'wallet.imports.keystore.upload': 'Choisir le fichier à uploader',
  'wallet.imports.phrase': 'Phrase',
  'wallet.imports.wallet': 'Importer un wallet existant',
  'wallet.imports.enterphrase': 'Entrez la phrase',
  ...
  'wallet.phrase.error.valueRequired': 'La valeur de la phrase est requise',
  'wallet.phrase.error.invalid': 'Phrase incorrecte',
  'wallet.phrase.error.import': "Erreur lors de l'import de la phrase",
  'wallet.txs.last90days': 'Transactions des 90 derniers jours',
  'wallet.empty.phrase.import': 'Importer un wallet existant déjà alimenté en fonds',
  'wallet.empty.phrase.create': "Créez un nouveau wallet, et l'alimenter en fonds",
  'wallet.create.copy.phrase': 'Copiez la phrase ci-dessous',
  'wallet.create.title': 'Créer un nouveau wallet',
  'wallet.create.enter.phrase': 'Entrez la phrase correctement',
  'wallet.create.words.click': 'Cliquez sur le mot dans le bon ordre',
  'wallet.create.creating': 'Création du wallet',
  ...
  'wallet.receive.address.errorQR': 'Erreur lors du rendu du QR code : {error}',
  ...
  'wallet.errors.address.empty': "L'adresse ne peut pas être vide",
