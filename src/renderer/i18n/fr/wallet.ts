...
const wallet: WalletMessages = {
  ...
  'wallet.action.remove': 'Supprimer',
  ...
  'wallet.remove.label.title': 'Are you sure you want to remove your wallet? - FR',
  'wallet.remove.label.description':
    'You cannot undo this action and will have to re-create your wallet from your seed phrase. - FR',
