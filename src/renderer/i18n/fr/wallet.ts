...
const wallet: WalletMessages = {
  ...
  'wallet.phrase.error.valueRequired': 'La phrase est requise',
  'wallet.phrase.error.invalid': 'Phrase incorrecte',
  'wallet.phrase.error.import': "Erreur lors de l'importation de la phrase",
  'wallet.txs.last90days': 'Transactions des 90 derniers jours',
  'wallet.empty.phrase.import': 'Importer un wallet existant contenant des fonds',
