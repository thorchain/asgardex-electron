...
const deposit: DepositMessages = {
  ...
  'deposit.withdraw.sym': 'Withdraw {asset1} + {asset2} - FR',
  'deposit.withdraw.asym': 'Withdraw {asset} - fR',
  'deposit.withdraw.sym.title': 'Adjust withdrawal (symmetrical) - FR',
  'deposit.withdraw.asym.title': 'Adjust withdrawal (asymmetrical) - FR',
