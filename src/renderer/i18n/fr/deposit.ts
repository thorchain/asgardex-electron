...
const deposit: DepositMessages = {
  ...
  'deposit.add.pendingAssets.title': 'Pending assets found - FR',
  'deposit.add.pendingAssets.description':
    'Transactions of an asset pair might take different time by running on different blockchains. Following assets are successful sent, but transaction of the another asset has not been successful listed yet: - FR',
  ...
  'deposit.poolDetails.totalTx': 'Txs (total) - FR',
  'deposit.poolDetails.totalFees': 'Fees (total) - FR',
