...
export const Swap = ({
  ...
  const targetFeeInTargetAsset: BaseAmount = useMemo(() => {
    const {
    ...
    () =>
      FP.pipe(
        ...
        RD.map(({ inFee }) => [
          ...
          { asset: targetAssetProp, amount: targetFeeInTargetAsset }
        ])
      ),
    [swapFeesRD, targetAssetProp, targetFeeInTargetAsset]
  )
