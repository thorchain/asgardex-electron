...
describe('stake/Withdraw.helper', () => {
  describe('getWithdrawAmounts', () => {
    it('zero percentes', () => {
      ...
      expect(withdraws.rune.amount()).toEqual(bn(0))
      expect(withdraws.asset.amount()).toEqual(bn(0))
    })

    it('50 percentes', () => {
      const withdraws = getWithdrawAmounts(baseAmount('193011422'), baseAmount('3202499'), 50)
      expect(withdraws.rune.amount()).toEqual(bn(0.96505711))
      expect(withdraws.asset.amount()).toEqual(bn(0.0160125))
    })

    it('100 percentes', () => {
      const withdraws = getWithdrawAmounts(baseAmount('193011422'), baseAmount('3202499'), 100)
      expect(withdraws.rune.amount()).toEqual(bn(1.93011422))
      expect(withdraws.asset.amount()).toEqual(bn(0.03202499))
    })
  })
})
