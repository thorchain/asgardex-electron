...
import { BalancesState, BalancesStateFilter, KeystoreState, KeystoreLedgerAddresses, LoadTxsHandler } from './types'
...
export const INITIAL_KEYSTORE_LEDGER_ADDRESSES: KeystoreLedgerAddresses = [] // empty by default
