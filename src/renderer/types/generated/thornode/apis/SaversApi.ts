...
export class SaversApi extends BaseAPI {
     ...
     */
    saver = ({ asset, address, height }: SaverRequest): Observable<Saver> => {
     ...
     */
    savers = ({ asset, height }: SaversRequest): Observable<Array<Saver>> => {
        ...
        return this.request<Array<Saver>>({
